...
:- dynamic on_t1/0, on_t2/0, off_t1/0, off_t2/0, on_t3/0, off_t3/0, on_t4/0, off_t4/0, plugged_bath/0, unplugged_bath/0, plugged_sink/0, unplugged_sink/0.

% See assignment description for the intended
...
pressurized_p4.
pressurized_p2 :- on_t4, pressurized_p4.
% p3 is pressurized if t1 is on
pressurized_p3 :- on_t1, pressurized_p1.
pressurized_p3 :- on_t4, pressurized_p4.
